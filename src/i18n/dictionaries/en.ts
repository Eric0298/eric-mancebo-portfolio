...
export const en = {
  ...
  aboutPage: {
    ...
    manifesto: {
      phrase: "Technology with purpose",
      support:
    ...
    origin: {
      ...
      backgroundLabel: "Future scene",
      backgroundNote: "Reserved for an editorial image or video of real work.",
      narrativeBlocks: [
    ...
    horizontalStory: {
      ariaLabel: "Professional principles in five scenes",
      progressLabel: "Principles progress",
      chapters: [
        {
          label: "THINKING",
          ...
          visualLabel: "Product thinking and usage context",
          visualNote: "Editorial image about product thinking.",
        ...
        {
          label: "DETAIL",
          title: "Care about every decision",
          summary:
          ...
          visualLabel: "Detail applied to interface and process",
          visualNote: "Editorial image about interface decisions.",
        ...
        },
        {
          ...
          visualLabel: "Technical standard and maintainable foundation",
          visualNote: "Editorial image about systems ready to grow.",
        ...
        },
        {
          ...
          visualLabel: "Product layers connected with intent",
          visualNote: "Editorial image about technology connected with purpose.",
        ...
        {
          label: "COMMITMENT",
          title: "Professional even when nobody is watching",
          summary:
          ...
          visualLabel: "Professional commitment and sustained responsibility",
          visualNote: "Editorial image about professional commitment in changing contexts.",
    ...
    timeline: {
      ...
      items: [
        ...
        {
          label: "2022",
          title: "Professional growth while working",
          summary:
        ...
        {
          label: "2024",
          title: "Web development as a new direction",
          summary:
        ...
        {
          label: "2025",
          title: "Personal projects and product judgement",
          summary:
        ...
        {
          label: "2026",
          title: "Professional leap into web development",
          summary:
      ...
      media: [
        {
          ...
          imageAlt: "Editorial portrait of Eric with a graphic composition about identity and detail",
          imagePosition: "center 42%",
          width: 941,
          height: 1672,
        },
        {
          ...
          imageAlt: "Red poster about controlling software chaos",
          imagePosition: "center",
          width: 1049,
          height: 1500,
        },
        {
          ...
          imageAlt: "Eric working at a computer in an editorial composition",
        ...
        },
        {
          ...
          imageAlt: "Eric surrounded by code, backend architecture and technical windows",
          imagePosition: "center 42%",
          width: 1122,
          height: 1402,
        },
        {
          ...
          imageAlt: "Minimal poster with a Control key and a message about narrative",
          imagePosition: "center 42%",
          width: 736,
          height: 1308,
        },
        {
          ...
          imageAlt: "Portrait of Eric with text about design, story and listening",
  ...
  contactPage: {
    ...
    title: "Let’s talk",
    subtitle: "Tell me what you need to build, improve or automate.",
    directIntro: "You can also reach me directly through these channels.",
    availability: {
      eyebrow: "Availability",
      title: "Direct contact for projects and hiring",
      summary:
        "Open to web projects, digital product, automation, collaboration, and hiring conversations with clear next steps.",
    },
    methods: {
      email: "Email",
      whatsapp: "WhatsApp",
      phone: "Phone",
      linkedinHiring: "LinkedIn for hiring",
      unavailable: "Channel to configure",
    },
    form: {
      name: "Name",
      email: "Email",
      ...
      message: "Message",
      optional: "optional",
      consent: "I agree that Eric Mancebo may use this data only to reply to my request.",
      submit: "Send message",
      ...
      placeholders: {
        ...
        phone: "Number if you prefer a call or WhatsApp",
        reason: "Select a reason",
        message: "Share context, goal, and approximate timing.",
      },
      reasons: [
        { value: "web", label: "Web project" },
        { value: "app", label: "App / digital product" },
        { value: "automation", label: "Automation" },
        { value: "hiring", label: "Job offer / hiring" },
        { value: "collaboration", label: "Collaboration" },
        { value: "other", label: "Other" },
      ],
      messages: {
        success: "Message sent successfully.",
        failure: "The message could not be sent. Try again or contact me by email.",
        invalid: "Please review the highlighted fields.",
        mailto: "I have prepared the message in your email client.",
      },
      errors: {
        ...
        reasonRequired: "Select a contact reason.",
        messageRequired: "Message is required.",
        consentRequired: "You must agree to this data use so I can reply to your request.",
      },
    },
  },
  sections: {
    hero: {
      key: "hero",
      anchor: "hero",
      eyebrow: "Hi, my name is Eric and I build digital product",
      title: "Eric Mancebo",
      summary:
  ...
  hero: {
    ...
    supportingParagraph: "based in Valencia, Spain.",
    snapshotLabel: "Technical signals",
    architectureSignals: ["Astro", "React", "TypeScript", "Automation"],
