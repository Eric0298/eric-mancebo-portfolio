...
export const es = {
  ...
  aboutPage: {
    hero: {
      ...
      summary:
        "Full Stack Developer · Desarrollo web · Producto digital · Automatización",
    ...
    manifesto: {
      phrase: "Tecnología con sentido",
      support:
        "A lo largo de mi experiencia creando productos digitales y aplicaciones web he aprendido que una buena solución no depende solo de escribir código. También importan el SEO, el marketing, la seguridad, la arquitectura, las buenas prácticas, el rendimiento, la accesibilidad y la forma en la que una persona va a utilizar realmente el producto. Para mí, desarrollar no es solo construir pantallas. Es entender el contexto, tomar mejores decisiones y crear soluciones digitales que tengan sentido desde dentro.",
      placeholders: ["procesos", "trabajo real", "producto"],
      media: [
        {
          imageSrc: "/images/about-me/seccion1/1.png",
          imagePosition: "center",
          width: 1024,
          height: 1536,
        },
        {
          imageSrc: "/images/about-me/seccion1/3.jpg",
          imagePosition: "center",
          width: 736,
          height: 736,
        },
        {
          imageSrc: "/images/about-me/seccion1/4.jpg",
          imagePosition: "center",
          width: 736,
          height: 736,
        },
        {
          imageSrc: "/images/about-me/seccion1/2.png",
          imagePosition: "center",
          width: 1122,
          height: 1402,
        },
    ...
    origin: {
      ...
      backgroundLabel: "Escena futura",
      backgroundNote: "Reserva para una imagen o vídeo editorial de trabajo real.",
      narrativeBlocks: [
        "Hola, soy Eric Mancebo Muminhodzic. Soy Full Stack Developer y esta es mi historia resumida.",
        "Por ciertas situaciones de la vida, tuve que dejar de estudiar a una edad temprana y empezar a trabajar. Lejos de verlo solo como una mala etapa, aquello me hizo espabilar, madurar y volverme más ambicioso.",
        "Al principio pasé por sectores como la hostelería y el almacén. Cada trabajo me enseñó algo distinto: trato con personas, ritmo, responsabilidad, organización, presión, procesos y pequeños detalles que muchas veces marcan la diferencia en un negocio.",
        "En lugar de quedarme quieto, empecé a crecer en paralelo mientras trabajaba. Me formé por mi cuenta, mejoré mi inglés hasta obtener el B2 de Cambridge, me interesé por el SEO y el marketing, me saqué el carnet de conducir y terminé el Grado Superior de Desarrollo de Aplicaciones Web.",
        "Con el tiempo, todo empezó a conectarse. La experiencia laboral me ayudó a entender mejor los problemas reales, y la formación técnica me dio las herramientas para transformarlos en soluciones digitales.",
        "Ahora soy desarrollador Full Stack y me dedico a crear software, aplicaciones web y producto digital para personas y negocios que necesitan soluciones útiles, claras y bien pensadas.",
        "No lo veo como el cierre de una etapa, sino como el inicio de una dirección profesional que quiero seguir ampliando. Actualmente continúo formándome en Ingeniería Informática mientras desarrollo proyectos y sigo aprendiendo sobre tecnología, producto digital, automatización e IA aplicada.",
      ],
      placeholders: ["cliente", "pedidos", "ecommerce", "procesos", "aprendizaje"],
    },
    horizontalStory: {
      ariaLabel: "Principios profesionales en cinco escenas",
      progressLabel: "Progreso de los principios",
      chapters: [
        {
          label: "CRITERIO",
          title: "Pensar más allá de la pantalla",
          summary:
            "No empiezo preguntando solo qué componente hay que hacer. Primero intento entender qué problema resuelve, qué proceso toca y qué impacto tendrá para quien lo usa.",
          visualLabel: "Criterio de producto y contexto de uso",
          visualNote: "Imagen editorial sobre pensamiento de producto.",
          imageSrc: "/images/about-me/carrusel-horizontal/FotoCarrusel2.png",
          imagePosition: "center",
          layout: "text-left",
        },
        {
          label: "DETALLE",
          title: "Cuidar cada decisión",
          summary:
            "La estructura, el rendimiento, la accesibilidad, el copy y el flujo importan. Una buena interfaz no solo se ve bien: se entiende, responde y acompaña.",
          visualLabel: "Detalle aplicado a interfaz y proceso",
          visualNote: "Imagen editorial sobre decisiones de interfaz.",
          imageSrc: "/images/about-me/carrusel-horizontal/FotoCarrusel3.png",
          imagePosition: "58% center",
          layout: "text-left",
        },
        {
          label: "ESTÁNDAR",
          title: "Que funcione no es suficiente",
          summary:
            "Me interesa construir piezas mantenibles, legibles y preparadas para crecer. El objetivo no es solo entregar una pantalla, sino dejar una base que pueda evolucionar.",
          visualLabel: "Estándar técnico y base mantenible",
          visualNote: "Imagen editorial sobre sistemas preparados para crecer.",
          imageSrc: "/images/about-me/carrusel-horizontal/FotoCarrusel4%20.png",
          imagePosition: "64% center",
          layout: "text-left",
        },
        {
          label: "PRODUCTO",
          title: "Conectar las capas",
          summary:
            "Frontend, backend, datos, SEO, automatización e IA no deberían vivir aislados. Cuando se conectan con intención, la tecnología empieza a resolver trabajo real.",
          visualLabel: "Capas de producto conectadas con intención",
          visualNote: "Imagen editorial sobre tecnología conectada con propósito.",
          imageSrc: "/images/about-me/carrusel-horizontal/FotoCarrusel1.png",
          imagePosition: "center",
          layout: "text-left",
        },
        {
          label: "COMPROMISO",
          title: "Profesional también cuando nadie mira",
          summary:
            "La calidad no depende solo del momento perfecto. También se demuestra en cómo se responde cuando hay presión, descanso, festivos o imprevistos. Para mí, ser profesional es cuidar el criterio, el tono y la responsabilidad incluso cuando el contexto no acompaña.",
          visualLabel: "Compromiso profesional y responsabilidad sostenida",
          visualNote: "Imagen editorial sobre compromiso profesional en contextos cambiantes.",
          imageSrc: "/images/about-me/carrusel-horizontal/FotoCarrusel5.png",
    ...
    timeline: {
      ...
      items: [
        ...
        {
          label: "2022",
          title: "Crecimiento profesional mientras trabajaba",
          summary:
            "Mientras seguía trabajando, empecé a construir una base profesional más amplia. Mejoré mi inglés hasta obtener el B2 de Cambridge, aprendí de forma autodidacta sobre SEO y marketing, me saqué el carnet de conducir y fui preparando el terreno para dar un salto real.",
          visualLabel: "Inglés",
          visualNote: "Placeholder para notas, certificados o material de estudio.",
        },
        {
          label: "2024",
          title: "Desarrollo web como nueva dirección",
          summary:
            "El Grado Superior de Desarrollo de Aplicaciones Web me permitió convertir esa inquietud en una dirección concreta: frontend, backend, bases de datos, despliegue, arquitectura y construcción de aplicaciones web reales.",
          visualLabel: "DAW",
          visualNote: "Espacio reservado para cuaderno técnico y pantalla.",
        },
        {
          label: "2025",
          title: "Proyectos propios y criterio de producto",
          summary:
            "Con proyectos como KORUS y JustWriteIt empecé a unir desarrollo, diseño, automatización, SEO, IA y visión de producto. No solo quería practicar código, sino construir soluciones con intención.",
          visualLabel: "Proyectos",
          visualNote: "Slot editorial para bocetos, repos y producto en proceso.",
        },
        {
          label: "2026",
          title: "Salto profesional al desarrollo web",
          summary:
            "Después de unas prácticas en las que aprendí mucho trabajando sobre web, CRM/ERP, diseño, migración tecnológica e IA asistida, me he embarcado de lleno en el mundo del desarrollo web. Estoy expectante por crear más producto digital, seguir creciendo y aportar soluciones reales a quienes las necesitan.",
          visualLabel: "Beply",
      ...
      media: [
        {
          ...
          column: "left",
          imageSrc: "/images/about-me/StickySection/Sticky1.png",
          imageAlt: "Retrato editorial de Eric con composición gráfica sobre identidad y detalle",
          imagePosition: "center 42%",
          width: 941,
          height: 1672,
        },
        {
          ...
          column: "left",
          imageSrc: "/images/about-me/StickySection/Sticky2.png",
          imageAlt: "Póster rojo sobre controlar el caos del software",
          imagePosition: "center",
          width: 1049,
          height: 1500,
        },
        {
          ...
          column: "left",
          imageSrc: "/images/about-me/StickySection/Sticky3.png",
          imageAlt: "Eric trabajando frente al ordenador en una composición editorial",
        ...
        },
        {
          ...
          column: "right",
          imageSrc: "/images/about-me/StickySection/Sticky4.png",
          imageAlt: "Eric rodeado de código, arquitectura backend y ventanas técnicas",
          imagePosition: "center 42%",
          width: 1122,
          height: 1402,
        },
        {
          ...
          column: "right",
          imageSrc: "/images/about-me/StickySection/Sticky5.jpg",
          imageAlt: "Póster minimalista con una tecla Control y mensaje sobre narrativa",
          imagePosition: "center 42%",
          width: 736,
          height: 1308,
        },
        {
          ...
          column: "right",
          imageSrc: "/images/about-me/StickySection/Sticky6.png",
          imageAlt: "Retrato de Eric con texto sobre diseño, historia y escucha",
  ...
  contactPage: {
    ...
    title: "Hablemos",
    subtitle: "Cuéntame qué necesitas construir, mejorar o automatizar.",
    directIntro: "También puedes escribirme directamente por estos canales.",
    availability: {
      eyebrow: "Disponibilidad",
      title: "Contacto directo para proyectos y contratación",
      summary:
        "Abierto a proyectos web, producto digital, automatización, colaboración y conversaciones laborales con próximos pasos claros.",
    },
    methods: {
      email: "Correo",
      whatsapp: "WhatsApp",
      phone: "Teléfono",
      linkedinHiring: "LinkedIn para contrataciones",
      unavailable: "Canal por configurar",
    },
    form: {
      name: "Nombre",
      email: "Correo",
      ...
      message: "Mensaje",
      optional: "opcional",
      consent: "Acepto que Eric Mancebo use estos datos únicamente para responder a mi consulta.",
      submit: "Enviar mensaje",
      honeypot: "No rellenar este campo",
      notProvided: "No indicado",
      mailSubjectPrefix: "Contacto desde portfolio",
      placeholders: {
        name: "Tu nombre",
        email: "Tu correo profesional",
        phone: "Número si prefieres llamada o WhatsApp",
        reason: "Selecciona un motivo",
        message: "Cuéntame contexto, objetivo y plazo aproximado.",
      },
      reasons: [
        { value: "web", label: "Proyecto web" },
        { value: "app", label: "Aplicación / producto digital" },
        { value: "automation", label: "Automatización" },
        { value: "hiring", label: "Oferta laboral / contratación" },
        { value: "collaboration", label: "Colaboración" },
        { value: "other", label: "Otro" },
      ],
      messages: {
        success: "Mensaje enviado correctamente.",
        failure: "No se ha podido enviar el mensaje. Inténtalo de nuevo o contacta por correo.",
        invalid: "Revisa los campos marcados.",
        mailto: "He preparado el mensaje en tu cliente de correo.",
      },
      errors: {
        nameRequired: "El nombre es obligatorio.",
        emailRequired: "El correo es obligatorio.",
        emailInvalid: "Introduce un correo válido.",
        phoneInvalid: "Introduce un teléfono válido o deja el campo vacío.",
        reasonRequired: "Selecciona un motivo de contacto.",
        messageRequired: "El mensaje es obligatorio.",
        consentRequired: "Debes aceptar el uso de estos datos para responder a tu consulta.",
      },
    },
  },
  sections: {
    hero: {
      key: "hero",
      anchor: "hero",
      eyebrow: "Hola, soy Eric y desarrollo producto digital",
      title: "Eric Mancebo",
      summary:
  ...
  hero: {
    ...
    displayLines: ["Full Stack", "Developer"],
    supportingParagraph: "desde Valencia, España.",
    snapshotLabel: "Señales técnicas",
    architectureSignals: ["Astro", "React", "TypeScript", "Automatización"],
    ...
    channels: [
      {
        channel: "email",
        label: "Email",
        href: "mailto:ericmancebo6950@gmail.com",
        handle: "ericmancebo6950@gmail.com",
        summary:
